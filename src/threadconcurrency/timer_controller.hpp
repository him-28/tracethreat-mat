...
//#include <concurrency/Exception.hp>
...
class timer_manager {
 ...
 public:
  ...
  virtual boost::shared_ptr<const Thread_factory> threadFactory() const;

  virtual void threadFactory(boost::shared_ptr<const Thread_factory> value);
 ...
 private:
  boost::shared_ptr<const Thread_factory> threadFactory_;
  class Task;
  friend class Task;
  ...
  typedef std::multimap<int64_t, boost::shared_ptr<timer_manager::Task> >::iterator task_iterator;
