...
typedef struct yc_wrapper{
  typedef	YARA_COMPILER  compiler_wrapper;
}yc_wrapper_s; 

template<typename Compiler = yc_wrapper_s::compiler_wrapper>
class iwrapper
{
public:
	bool compile_rule(char ** filename) = 0;
	Compiler & get_compiler() = 0;
protected:
	Compiler * compiler;
};

template<typename Compiler>
class wrapper_rule_copmiles : protected iwrapper<Compiler>
{
public:
