...
namespace utils
{
    ...
    namespace connector
    {
        ...
        result_infected<MessageResult, FileStructure>::~result_infected()
        {
			...
			template class result_infected<scan_threat::InfectedFileInfoRequest, std::string>;

        //__________________________   result_pe_infected ____________________________________
        template<typename MessageResult, typename FileStructure>
        bool result_pe_infected<MessageResult, FileStructure>::add_infected_result(Signature *msig)
        {
            ...
            return true;
				...
				template class result_pe_infected<scan_threat::InfectedFileInfoRequest, std::string>;
