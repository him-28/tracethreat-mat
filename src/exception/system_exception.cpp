...
namespace trace_exception
{
    ...
    namespace system
    {
        ...
        option_system_exception::option_system_exception(std::string type) throw() : type_name(type) { }
    ...
    namespace cl
    {
        clbootstrap_exception::clbootstrap_exception(std::string type) throw() : type_name(type) { }
        ...
        clutil_exception::clutil_exception(cl_int err, const std::string& name)
    ...
    namespace file_system
    {
        ...
        error_code_entry::error_code_entry() {  }
        ...
        offset_exception::offset_exception(std::string type_name)
        ...
        offset_exception::~offset_exception() throw() {}
				...
				//template class offset_exception;
    }
